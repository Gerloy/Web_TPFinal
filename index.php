    ...
    <div class="container cont">
      ...
      <div class="row">
        <div class="col s2 offset-s1">
          <a href="#TP1" class="link2"><h4>TP1<h4></a>
        </div>
        <div class="col s2">
          <a href="#TP2" class="link2"><h4>TP2<h4></a>
        </div>
        <div class="col s2">
          <a href="#TP4" class="link2"><h4>TP4<h4></a>
        </div>
        <div class="col s2">
          <a href="#TP5" class="link2"><h4>TP5<h4></a>
        </div>
        <div class="col s2">
          <a href="#Info" class="link2"><h4>Info<h4></a>
        </div>
      </div>
      <!-- tp1 -->
      <div class= "row">
        <div class="col s12">
          <a name="TP1"><h4 class="white-text center-align">TP1: Círculo cromático</h4></a>
        </div>
      </div>
        <div class="frame">
...
translate(0,height/3);</pre></div>
      ...
      <div class= "row">
        <div class="col s12">
          <a name="TP2"><h4 class="white-text center-align">TP2: Secuencia de créditos</h4></a>
        </div>
      </div>
      <div class="frame">
...
void mouseClicked(){
  Y = 256;
      ...
      <div class= "row">
        <div class="col s12">
          <a name="TP4"><h4 class="white-text center-align">TP4: Aventura con funciones</h4></a>
        </div>
      </div>
      <div class="frame">
...
void Cargar(){
  ...
  cargado = true;
      ...
      <div class="row">
        <div class="col s12">
          <a name="TP5"><h4 class="white-text center-align">TP5: Juego con clases</h4></a>
        </div>
      </div>
      <div class="frame">
      ...
      <ul class="collapsible expandable">
        <li>
          <div class="collapsible-header">Info</div>
          <div class="collapsible-body cola">Éste TP consistió en programar un juego basado en alguna parte de la aventura del TP anterior y programarlo en Processing haciendo uso de calses y de una librería de sonido. Lo que hice fue tomar las partes de la aventura en las que el personaje recorre en subsuelo que encuentra en su casa y hacer un mapa bastante báscio que se pueda recorrer en primera persona haciendo uso del 3D (al principio iba a ser en 2D estilo Wolfenstein, pero tuve complicaciones con el tema de renderizar las paredes a distintas distancias, las colisiones con las mismas, y mostrar texturas por partes para no usar colores planos). Como digo en los comentarios del código, todo el movimiento, las colisiones y el volumen del sonido que cambia según la distancia entre el jugador y el monstruo está hecho en 2D, y tomé un proyecto anterior en el que hacía un cubo texturizado pasándole los tamaños y la posición central para renderizar eso que está en 2D a 3D. El único problema que tuve con esto fue como hacer que girara la cámara, quería hacer que cambiara el punto al que apuntaba según el ángulo en el que miraba el jugador, pero no cambiaba nada, así que lo resolví cambiando la posición cámara segú el ángulo en el que miraba el jugador, posicionándola a una distancia específica del mismo y poniéndo a la posición del jugador como el punto al que apuntaba, ya que al no tener ningún modelo asignado, no iba a obstaculizar la visión. También pensé en poner una interfaz gráfica para el temporizador y para saber la distancia a la que está el jugador del monstruo, pero no sabía como resolverla, no encontraba una forma simple de hacerla funcionar con la cámara cambiando siempre de posición y de ángulo (y como faltaba menos de un día para la fecha límite no podía correr el riesgo de que quedara bugeada) y no me gustaba el hecho de hacer un interfaz que pudiera "romper con la atmósfera del juego" al ser algo extradiegético, así que terminé aprovechando que había que usar sonido y que minim permite modificar el gain de los archivos de audio para en lugar de hacer la interfáz gráfica, resolver eso con sonidos, el sonido del corazón funciona como temporizador, reduciendo el cooldown que tiene entre una reproducción y la siguiente a intervalos específicos de tiempo, y el sonido del monstruo arrastrándose, que se hace más fuerte mientras más cerca esté el jugador del monstruo.</div>
        </li>
        <li>
          <div class="collapsible-header">Código</div>
          <div class="collapsible-body cola">
...
posición en Z del translate*/
  ...
  void Mostrar() {
    ...
    <div class="row">
      <div class="col s8 offset-s2">
        <p class="flow-text  white-text txt">No puse el TP final porque no pude grabarlo con ningún método, ni siquiera con bajos fps, directamente se queda en un frame como 3 minutos y después cambia a otro por otros 3 minutos, así que preferí no ponerlo. Igual dejo el link al proyect en GitHub por acá:</p>
        <ul><a href="https://github.com/Gerloy/tecnomultimedia/tree/tpfinal"> <li class="link2">TPfinal</li></a></ul>
      </div>
    </div>
    <div class="row">
      <div class="col s12">
    ...
    <div class="row">
      <div class="col s12">
        <a name="Info"><h4 class="white-text center-align">Información del autor</h4></a>
    </div>
    <div class="row">
      <div class="col s8 offset-s2">
        <p class="flow-text  center-align white-text txt">Nombre: Germán Eloy Iñiguez<br>Numero: 81697/3</p>
      </div>
    </div>
    </div>

    <a href="#up" class="simplescrollup__button simplescrollup__button--hide link2">Ir arriba</a>
    <script type="text/javascript" src="js/jquery.min.js"></script>
    <script type="text/javascript" src="js/materialize.min.js"></script>
    <script type="text/javascript" src="js/simplescrollup.js"></script>
